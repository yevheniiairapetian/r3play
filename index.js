...
/**
 * API call to get all "/tv series" returning JSON object (Returns all tv series)
 * @name getTVSeries
 * @async
 */
...
/**
 * API call to get "/movies/genres/genreName" returning json object with a genre name and description
 * @name getMovieGenre
 * @async
 */
...
/**
 * API call to get "/animes/genres/animeName" returning json object with an amime name and description
 * @name getAnimeGenre
 * @async
 */
...
/**
 * API call to get "/tvseries/genres/tvName" returning json object with a tv series name and description
 * @name getTVGenre
 * @async
 */
...
/**
 * API call to get "/movies/directors/directorName" returning json object with a movie director name and bio
